...
import { loginEntityApi } from "./userActionCreatore"; // Make sure this function returns a Promise
 ...
 setDarkMode(detectDarkmode)
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Handle different types of errors (e.g., network, server errors)
  ...
  return (
    <>
      <div className=" flex w-full dark:bg-black transition-all dark:text-white h-screen items-center ">
        <form
        ...
        >
          ...
          <div className="mt-2 text-center">
            <p>
              Dont have an account ?<Link to={"/singup"}> Create account </Link>
            </p>
          </div>
        </form>
